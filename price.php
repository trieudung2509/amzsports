              ...
              <span class="icon-checked">
                ...
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <g clip-path="url(#clip0_409_9784)">
                    <path d="M7.33301 12.0001L10.6663 15.3334L17.333 8.66675" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                  </g>
                  <defs>
        ...
        <div class="left-content">
          ...
          <div class="enter-coupon-code-wrapper">
            ...
            <div class="input-coupon-code-wrapper">
              <input type="text" name="" value="" placeholder="Enter coupon code" />
            ...
            <p class="description">
              <span class="icon">
                ...
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <rect x="0.666992" y="0.666504" width="14.6667" height="14.6667" rx="7.33333" fill="#007649" />
                  <g clip-path="url(#clip0_409_10495)">
                    <path d="M4.88965 8.00005L7.11187 10.2223L11.5563 5.77783" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                  </g>
                  <defs>
                    <clipPath id="clip0_409_10495">
          ...
          <p class="txt-privacy">By proceeding, you agree to our <span class="txt-highlight">Terms of Service</span> and
            <span class="txt-highlight">Privacy Policy.</span>
          </p>
        </div>
          ...
          <ul class="list-feature">
            <li>
              <span class="icon">
                ...
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g clip-path="url(#clip0_409_9821)">
                    <path d="M3.33301 7.99984L6.66634 11.3332L13.333 4.6665" stroke="#007649" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                  </g>
                  <defs>
                    <clipPath id="clip0_409_9821">
                      <rect width="16" height="16" fill="white" />
                    </clipPath>
                  </defs>
                </svg>
      ...
      <div class="container">
        <div class="vpn-internaltiona-server-content">
          <div class="left-content">
            ...
            <p class="description">
              Choose from thousands of super-fast VPN servers around the world. Enjoy a stable connection wherever you
              are.
            </p>
            <div class="list-item">
              <div class="item">
              ...
              <div class="item">
                ...
                <span class="icon">
                  ...
                  <svg width="79" height="38" viewBox="0 0 79 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_409_9724)">
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M12.978 0L31.805 19L12.978 38H0L18.829 19L0 0H12.978ZM36.574 0L55.403 19L36.574 38H23.597L42.426 19L23.597 0H36.574ZM60.172 0L79 19L60.172 38H47.195L66.023 19L47.195 0H60.172Z" fill="#007649" />
                    </g>
                    <defs>
                      <clipPath id="clip0_409_9724">
