      ...
      <div class="container">
        <div class="row">
            <div class="match-header">
                <h5>Liverpool - Chelsea</h5>
                <div class="match-time">
                    <p>10/08/2022 02:00</p>
                    <div class="match-social">
                        <ul class="social-ul">
                            ...
                            <li>
                                <a href="">
                                  <img src="/images/curved-next.png" alt="">
                                </a>
                            </li>
                        </ul>
                    </div>
              ...
              <div class="match-play">
                  ...
                  <div class="match-server">
                      <ul class="server-list">
                        <li class="active">
                          <a href="" class="btn btn-server">Server 1</a>
                        </li>
                        <li>
                          <a href="" class="btn btn-server">Server 2</a>
                        </li>
                        <li>
                          <a href="" class="btn btn-server">Server 3</a>
                        </li>
                      </ul>
                  </div>
              </div>
              ...
              <div class="block-head">
                  <table>
                    <tbody>
                      <tr>
                        <td>
                            <div class="total-win right">
                                <span class="loading" style="width: 10%" ></span>
                            </div>
                        </td>
                        <td>
                          <span>11</span>
                        ...
                        <td rowspan="3" class="play-center" >
                          <div class="play-td">
                            <span>Played</span>
                            <p>28</p>
                            <span class="draws">Draws: 9</span>
                          </div>
                        </td>
                        <td>
                          <span>
                        ...
                        <td>
                            <div class="total-win left">
                                <span class="loading" style="width: 20%"></span>
                            </div>
                        </td>
                      </tr>
                      <tr>
                        <td>
                            <div class="total-win right">
                                <span class="loading" style="width: 30%"></span>
                            </div>
                        </td>
                        <td>
                          <span>11</span>
                      ...
                      <tr>
                        <td>
                            <div class="total-win right">
                                <span class="loading" style="width: 50%"></span>
                            </div>
                        </td>
                        <td>
                          <span>11</span>
                        ...
                        <td>
                            <div class="total-win left">
                                <span class="loading" style="width: 53%"></span>
                            </div>
                        </td>
                      </tr>
                    </tbody>
              ...
              <table class="table">
                <tbody class="tbody-match">
                  <tr>
                    <td>
                      <div class="td-first">
                        <span>Saturday 15 May 2004</span>
                        <div class="bottom-premier-item">
                          <span>Liverpool</span>
                            <img src="/images/mu.png" alt="">
                        </div>
